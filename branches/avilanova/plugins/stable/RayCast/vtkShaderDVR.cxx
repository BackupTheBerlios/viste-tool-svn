...
vtkStandardNewMacro( vtkShaderDVR );

///////////////////////////////////////////////////////////////////
vtkShaderDVR::vtkShaderDVR()
{
}
...
///////////////////////////////////////////////////////////////////
std::string vtkShaderDVR::GetVertexShader()
{
...
std::string vtkShaderDVR::GetFragShader()
{
  ...
  str << "	vec3 ambient  = Sa * vec3( 0.6, 0.6, 0.6 );\n";
  str << "	vec3 diffuse  = Sd * vec3( 0.6, 0.6, 0.6 );\n";
  str << "	vec3 specular = Ss * vec3( 0.6, 0.6, 0.6 );\n";
  str << "	if( Sd <= 0.0 )\n";
  str << "		specular = vec3( 0 );\n";
  ...
  str << "		vec4 src = texture1D( tfBuffer, sample );\n";
  str << "		src.a = 1.0 - pow( (1.0 - src.a), stepSize );\n";
  str << "		vec3 N = computeNormal( volumeBuffer, position );\n";
  str << "		vec3 V = rayDir;\n";
  str << "		vec3 L = V;\n";
  str << "    src.rgb = applyLighting( src.rgb, N, V, L );\n";
  str << "		src.rgb *= src.a;\n";
  str << "		dst = (1.0 - dst.a) * src + dst;\n";
