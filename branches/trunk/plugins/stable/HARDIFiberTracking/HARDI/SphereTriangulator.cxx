...
{
	cout << "triangulateFromUnitVectors" << endl;
	...
	//cout << "delaunay start"<< endl;
	//cin.get();
	// Run the triangulation filter
	delaunay->Update();
	//cout << "delaunay end"<< endl;
	//cin.get();
	...
	vtkIdType * pointList;
	//cout << "start loop all polygons"<< endl;
	//cin.get();
