/*=========================================================================
  ...
  Module:    $RCSfile: vtkInteractorStyleSwitchFixed.cxx,v $
...
vtkCxxRevisionMacro(vtkInteractorStyleSwitchFixed, "$Revision: 1.1 $");
vtkStandardNewMacro(vtkInteractorStyleSwitchFixed);

//----------------------------------------------------------------------------
vtkInteractorStyleSwitchFixed::vtkInteractorStyleSwitchFixed() 
{
  ...
  this->CurrentStyle = 0;
  //cout<<"created fixed InteractorStyleSwitch"<<endl;
}
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::SetAutoAdjustCameraClippingRange( int value )
{
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::SetCurrentStyleToJoystickActor()
{
  this->JoystickOrTrackball = VTKIS_JOYSTICK;
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::SetCurrentStyleToJoystickCamera()
{
  this->JoystickOrTrackball = VTKIS_JOYSTICK;
  this->CameraOrActor = VTKIS_CAMERA;
  this->SetCurrentStyle();
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::SetCurrentStyleToTrackballActor()
{
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::SetCurrentStyleToTrackballCamera()
{
  this->JoystickOrTrackball = VTKIS_TRACKBALL;
  this->CameraOrActor = VTKIS_CAMERA;
  this->SetCurrentStyle();
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::OnChar() 
{
...
void vtkInteractorStyleSwitchFixed::SetCurrentStyle()
{
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::SetInteractor(vtkRenderWindowInteractor *iren)
{
...
//----------------------------------------------------------------------------
void vtkInteractorStyleSwitchFixed::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkInteractorStyleSwitchFixed::SetDefaultRenderer(vtkRenderer* renderer)
{
...
void vtkInteractorStyleSwitchFixed::SetCurrentRenderer(vtkRenderer* renderer)
{
