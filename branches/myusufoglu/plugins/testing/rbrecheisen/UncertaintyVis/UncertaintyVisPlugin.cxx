...
//            this->interval->ReadFromString( str );
	...
	void UncertaintyVisPlugin::loadHeader()
	{
        ...
        //QString fileName = "/home/rbrecheis/datasets/tilburg/bekk070710_contrack/fibers/fibers_fact_peduncle_0_25_header.txt";
		QFile file( fileName );
		...
		std::cout << "UncertaintyVisPlugin::loadHeader() " \
                "read polydata " << fileNameData.toStdString() << std::endl;
		std::cout << "UncertaintyVisPlugin::loadHeader() " \
                "read confidence table " << fileNameTable.toStdString() << std::endl;
		file.close();
		...
		while( streamTable.atEnd() == false )
		{
            ...
            float confidence = tokens.at( 1 ).toFloat();
...
//			table->Invert();
        ...
        this->mapper->SetTable2(ids, scores);
