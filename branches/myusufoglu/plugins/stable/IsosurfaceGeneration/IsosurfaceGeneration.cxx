#include "IsosurfaceGeneration.h"
...
IsosurfaceGeneration::~IsosurfaceGeneration()
{
    delete this->widget;
    delete this->form;
}
...
void IsosurfaceGeneration::init()
{
...
void IsosurfaceGeneration::setupClippingPlanesPicker()
{
...
void IsosurfaceGeneration::dataSetAdded(data::DataSet * d)
{
...
void IsosurfaceGeneration::dataSetChanged(data::DataSet * d)
{
    // Assert the data set pointer (should never be NULL)
    Q_ASSERT(d);
...
void IsosurfaceGeneration::dataSetRemoved(data::DataSet * d)
{
    // Assert the data set pointer (should never be NULL)
    Q_ASSERT(d);
...
void IsosurfaceGeneration::createModelInfo(data::DataSet * d)
{
...
void IsosurfaceGeneration::createLookupTable(data::DataSet * d, int index)
{
...
{cout << "Add produced dataset as polydata: 0.0"<< endl;
    ...
    if(bModelDirty)
    {
		...
		//prop->LoadMaterial("D:/Research/Software/vISTe/source/plugins/testing/smeesters/IsosurfaceGeneration/ClippingPlane.xml");
		prop->LoadMaterial("/home/stephan/Research/Software/vISTe/src/smeesters/plugins/testing/smeesters/IsosurfaceGeneration/ClippingPlane.xml");
        //prop->LoadMaterial("/home/linux/Research/fMRIDTI_Visual/Software/vISTe/subversion/smeesters/plugins/testing/smeesters/IsosurfaceGeneration/ClippingPlane.xml");
...
void IsosurfaceGeneration::setClippingPlanesPosition(double* pos)
{
...
void IsosurfaceGeneration::updateClippingPlaneSlider(int direction, int value, bool render)
{
...
void IsosurfaceGeneration::updateClippingPlaneEnabled(int direction, bool checked)
{
...
void IsosurfaceGeneration::connectAll()
{
    // Select data set
...
void IsosurfaceGeneration::comboBoxDataChanged()
{
...
void IsosurfaceGeneration::comboBoxOverlayChanged()
{
    // select model info matching the dataset
...
void IsosurfaceGeneration::comboBoxOverlayLUTChanged()
{
    // select model info matching the dataset
...
void IsosurfaceGeneration::comboBoxBaseLayerLUTChanged()
{
    // select model info matching the dataset
...
void IsosurfaceGeneration::checkBoxVisibleChanged(bool checked)
{
...
void IsosurfaceGeneration::comboBoxStyleChanged()
{
    // select model info matching the dataset
...
void IsosurfaceGeneration::inputMaximumThresholdChanged(double value)
{
...
void IsosurfaceGeneration::inputMinimumThresholdChanged(double value)
{
...
void IsosurfaceGeneration::inputSmoothingChanged(double value)
{
...
void IsosurfaceGeneration::inputColorChanged()
{
    QColor oldColor;
...
void IsosurfaceGeneration::inputAlphaChanged(double value)
{
...
void IsosurfaceGeneration::inputSpecularChanged(double value)
{
...
void IsosurfaceGeneration::inputReductionChanged(double value)
{
...
void IsosurfaceGeneration::horizontalSliderXChanged(int value)
{
    this->BlockSignals();
...
void IsosurfaceGeneration::horizontalSliderYChanged(int value)
{
    this->BlockSignals();
...
void IsosurfaceGeneration::horizontalSliderZChanged(int value)
{
    this->BlockSignals();
...
void IsosurfaceGeneration::checkBoxXChanged(bool checked)
{
...
void IsosurfaceGeneration::checkBoxYChanged(bool checked)
{
...
void IsosurfaceGeneration::checkBoxZChanged(bool checked)
{
...
void IsosurfaceGeneration::checkBoxFlipXChanged(bool checked)
{
...
void IsosurfaceGeneration::checkBoxFlipYChanged(bool checked)
{
...
void IsosurfaceGeneration::checkBoxFlipZChanged(bool checked)
{
...
void IsosurfaceGeneration::spinXChanged(int value)
{
    this->BlockSignals();
...
void IsosurfaceGeneration::spinYChanged(int value)
{
    this->BlockSignals();
...
void IsosurfaceGeneration::spinZChanged(int value)
{
    this->BlockSignals();
...
void IsosurfaceGeneration::buttonSaveMeshClicked()
{
...
void IsosurfaceGeneration::checkBoxInvertClippingChanged(bool checked)
{
...
void IsosurfaceGeneration::checkBoxLargestComponentChanged(bool checked)
{
...
void IsosurfaceGeneration::checkBoxAlignPlanesToPickChanged(bool checked)
{
...
void IsosurfaceGeneration::BlockSignals()
{
...
void IsosurfaceGeneration::AllowSignals()
{
...
//
vtkProp * IsosurfaceGeneration::getVtkProp()
{
...
//
QWidget * IsosurfaceGeneration::getGUI()
{
    return this->widget;
}
...
Q_EXPORT_PLUGIN2(libIsosurfaceVisualization, bmia::IsosurfaceGeneration)
