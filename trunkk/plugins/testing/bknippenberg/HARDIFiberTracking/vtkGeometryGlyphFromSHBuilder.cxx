 ...
 * - Added functions to get unitVectors, trianglesArray and anglesArray
 */
...
*/
	...
	for (int i = 0; i < numberOfTessPoints; ++i)
	{
		...
		sc[0] = atan2((sqrt(pow(this->unitVectors[i][0], 2) + pow(this->unitVectors[i][1], 2))), this->unitVectors[i][2]);
...
std::vector<double*> vtkGeometryGlyphFromSHBuilder::getAnglesArray()
{
return this->anglesArray;
}

vtkIntArray * vtkGeometryGlyphFromSHBuilder::getTrianglesArray()
{
return this->trianglesArray;
}

double** vtkGeometryGlyphFromSHBuilder::getUnitVectors()
{
